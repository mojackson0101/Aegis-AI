...
import { Search, Globe, Shield, RefreshCw, Zap, Server, AlertCircle } from 'lucide-react';
      ...
      <form onSubmit={handleFormSubmit} className="space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1">
          ...
          <button
            ...
            className="text-xs px-2.5 py-1 rounded-lg bg-rose-950/40 hover:bg-rose-900/60 border border-rose-800/60 text-rose-300 font-mono transition-colors flex items-center gap-1"
          ...
          <button
            ...
            className="text-xs px-2.5 py-1 rounded-lg bg-slate-800/80 hover:bg-slate-800 border border-slate-700 text-slate-300 font-mono transition-colors"
          >
            owasp.org
          </button>
